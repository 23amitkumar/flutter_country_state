///list of states of each country
...
class Argentina{
  static List<String> states = <String>[
    ...
    "Santa Fe",
    "Santiago del Estero",
    "Tierra del Fuego, Antártida e Islas del Atlántico Sur", // Tierra del Fuego province with full name
    "Tucumán",
  ];
}
class Armenia{
...
class Italy{
  static List<String> states = <String>[
    ...
    "Sicily (Sicilia)",
    "Tuscany (Toscana)",
    "Trentino-Alto Adige/South Tyrol (Trentino-Alto Adige/Südtirol)",
    "Umbria",
...
class Slovenia{
  static List<String> states = <String>[
    "Pomurska (Mura Statistical Region)",
    "Podravska (Drava Statistical Region)",
    "Koroška (Carinthia Statistical Region)",
    "Savinjska (Savinja Statistical Region)",
    "Zasavska (Central Sava Statistical Region)",
    "Posavska (Lower Sava Statistical Region)",
    "Jugovzhodna Slovenija (Southeast Slovenia Statistical Region)",
    "Osrednjeslovenska (Central Slovenia Statistical Region)",
    "Gorenjska (Upper Carniola Statistical Region)",
    "Primorsko-notranjska (Littoral-Karst Statistical Region)",
    "Goriška (Gorizia Statistical Region)",
    "Obalno-kraška (Coastal-Karst Statistical Region)",
  ];
}
...
class Uzbekistan{
  static List<String> states = <String>[
    ...
    "Tashkent Region",
    "Xorazm Region",
    "Tashkent City (independent city)"
  ];
}
